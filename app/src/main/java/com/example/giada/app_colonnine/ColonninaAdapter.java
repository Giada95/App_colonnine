...
public class ColonninaAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null)
            convertView = LayoutInflater.from(context).inflate(R.layout.riga_colonnina, parent, false);

        // Ottengo gli id correnti
        TextView textIndirizzogenerico = (TextView)convertView.findViewById(R.id.textIndirizzogenerico);
        TextView textGestore = (TextView)convertView.findViewById(R.id.textGestore);
